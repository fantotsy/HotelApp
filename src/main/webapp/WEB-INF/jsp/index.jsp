...
<fmt:setBundle var="index" basename="properties.i18n.index"/>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
        <title><fmt:message key="title" bundle="${index}"/></title>
        <link href="/HotelApp/css/index.css" type="text/css" rel="stylesheet"/>
    </head>
    <body>
        <div id="main_wrapper">
            <div id="language">
                <a href="/HotelApp/index?language=en_US"><img src="/HotelApp/images/english_language.png" alt="english"
                                                     class="language_image"/></a>
                <a href="/HotelApp/index?language=ua_UA"><img src="/HotelApp/images/ukrainian_language.png" alt="ukrainian"
                                                     class="language_image"/></a>
            </div>
            <div id="wrapper">
                <header>
                ...
                <div id="sign_in_wrapper">
                    ...
                    <form action="/HotelApp/main" method="post" id="sign_in_form" class="clearfix">
                    ...
                    <form action="/HotelApp/registration" method="get" id="registration">
