...
<fmt:setBundle var="reservations" basename="properties.i18n.reservations"/>
<html>
    <head>
    ...
    <body>
        <div id="main_wrapper">
            ...
            <div id="table_wrapper">
                <form action="/HotelApp/admin" method="get">
                    ...
                    <c:forEach items="${requestScope.listOfReservations}" var="reservation">
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="/HotelApp/reservations" method="post">
