...
/**
 * Class {@code SQLQueriesGetter} consists of logic, which gets specific properties.SQL queries by their names.
 *
 * @author fantotsy
 * @version 1.0
 */
public final class SQLQueriesGetter {
    ...
    public static synchronized SQLQueriesGetter getInstance() {
        if (instance == null) {
            ...
            instance.resourceBundle = ResourceBundle.getBundle("properties.SQL.SQLs");
        }
        return instance;
    }
